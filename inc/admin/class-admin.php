...
if ( ! class_exists( 'HFWE_Admin', false ) ) :
    ...
    class HFWE_Admin {
        ...
        public function __construct() {
			...
			add_action( 'single_template', [ $this, 'load_canvas_template' ] );
			add_action( 'template_redirect', [ $this, 'redirect_template_frontend' ] );
		...
		public function save_meta( $post_id ) {
			...
			if ( isset( $_POST['hfwe_template_type'] ) ) {
				update_post_meta( $post_id, 'hfwe_template_type', sanitize_text_field( $_POST['hfwe_template_type'] ) );
			}
